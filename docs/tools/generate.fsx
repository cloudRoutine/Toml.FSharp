...
let githubLink = "http://github.com/cloudRoutine/toml-fs"

// Specify more information about your project
let info =
  [ "project-name", "toml-fs"
    "project-author", "Jared Hester"
    "project-summary", "FParsec TOML Parser for F#"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/toml-fs" ]
